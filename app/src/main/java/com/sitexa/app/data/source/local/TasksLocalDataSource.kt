...
class TasksLocalDataSource private constructor(context: Context) : TasksDataSource {
    ...
    override fun getTask(taskId: String, callback: TasksDataSource.GetTaskCallback) {
        ...
        val projection = arrayOf<String>(TasksPersistenceContract.TaskEntry.COLUMN_NAME_ENTRY_ID, TasksPersistenceContract.TaskEntry.COLUMN_NAME_TITLE, TasksPersistenceContract.TaskEntry.COLUMN_NAME_DESCRIPTION, TaskEntry.COLUMN_NAME_COMPLETED)
